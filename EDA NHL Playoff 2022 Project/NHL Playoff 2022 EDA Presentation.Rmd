...
```{r, echo = FALSE}
library(tidyverse)
playoff_shot_data <- read_csv("~/CMU_Summer_2022/EDA NHL Playoff 2022 Project/nhl_playoffs_shots_2022.csv")
...
---
**Grouping players by their offensive shot output in home and away settings**
```{r, echo = FALSE, fig.width= 9, fig.height= 5}
...
# shots on goal density curve with home and away
...
- Is there a trend that more left handed shooters take shots closer to the goals than right handed players?

--

- We can see that shot type varies by the distance away the player is from their scoring goal

--

- We can see how some players vary based on where they play and that some players are much more elite depending on their location
  - Should Karill Kaprizov be considered the best player in terms of generating offense for himself?

--

- We can see some distinct patterns between home and away teams of how they tend to play their games based on the location
